...
int delayTime = 50;              // variable for delay time - required so we can update it as the program runs!
...
void loop() {
  ...
  if (delayTime < 500) {
    delayTime = delayTime + 50;  // could also use the shorter delayTime += 50, which is the same thing!
  }
